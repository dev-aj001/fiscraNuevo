...
import interfaz.ventanasEmergentes.EstatusVisita;
import interfaz.ventanasEmergentes.EstatusVisitaEm;
import interfaz.ventanasEmergentes.ModificarUsuario;
import interfaz.ventanasEmergentes.ModificarVisita;
import interfaz.ventanasEmergentes.RegistrarUsuario;
import interfaz.ventanasEmergentes.RegistrarVisita;
 ...
 * @author jairi
 */
public class PanelVisitasEm extends javax.swing.JPanel {
    ...
    //Singleton
    private static PanelVisitasEm instance;
    
    public static PanelVisitasEm getInstance(){
        if(instance == null){
            instance = new PanelVisitasEm();
        }
        return instance;
    }
    ...
    public Visita getVisita() {
        try {
            ...
            visitaSeleccionada = new JPAController().getVisita(id);
            pacienteSeleccionado = visitaSeleccionada.getPacienteidPaciente();
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Asunto", "Paciente", "Visitante", "Parentesco", "Fecha", "Hora", "Estatus"
            }
        ));
    ...
    private void btnDesactivarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDesactivarActionPerformed
        // TODO add your handling code here:
        new EstatusVisitaEm(this).setVisible(true);
