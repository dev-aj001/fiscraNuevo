...
public class ModificarVisita extends javax.swing.JFrame {
    ...
    public ModificarVisita(PanelVisitas clase) {
        initComponents();
        this.clase=clase;
        visitaSeleccionada = clase.getVisita();
    ...
    public void llenarDatos(){
        txtAsunto.setText(visitaSeleccionada.getAsunto());
        txtVisitante.setText(visitaSeleccionada.getFamiliar());
        date.setDate(visitaSeleccionada.getFecha());
        ...
        for (int i = 0;i>=listPacientes.size();i++) {
            if(listPacientes.get(i).equals(p)){
                cmbidpaciente.setSelectedIndex(i);
                break;
            }
    ...
    private void btnOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOKActionPerformed
        ...
        visitaSeleccionada.setFecha(date.getDate());
        visitaSeleccionada.setHora(cmbhora.getSelectedItem().toString());
        //visita.setEstatus(0);
        ...
        */
        JPAController jpa = new JPAController();
        jpa.updateVisita(visitaSeleccionada);
        clase.actualizarTabla();
        JOptionPane.showMessageDialog(this, "Se modifico la visita visita  exitosamente");
