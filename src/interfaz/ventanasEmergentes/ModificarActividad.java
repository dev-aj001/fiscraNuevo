...
public class ModificarActividad extends javax.swing.JFrame {
    ...
    Actividad actividad;
    public ModificarActividad(PanelActividades clase) {
        initComponents();
        this.clase=clase;
    ...
    private void initComponents() {
        ...
        pnlHoraLayout.setHorizontalGroup(
            ...
            .addGroup(pnlHoraLayout.createSequentialGroup()
                ...
                .addComponent(date, javax.swing.GroupLayout.DEFAULT_SIZE, 201, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(cmbhora, 0, 132, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        JOptionPane.showMessageDialog(this, "Se modifico actividad  exitosamente");
    ...
    private void llenarDatos() {
        ...
        txtDesc.setText(actividad.getDecripcion());
        cmbPrioridad.setSelectedIndex(actividad.getPrioridad());
        
        int hor = Integer.parseInt(actividad.getHoraInicio().split(":")[0])%10;
